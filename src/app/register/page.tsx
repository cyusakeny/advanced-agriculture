        ...
        <div className="flex justify-center items-center  w-full  h-screen">
                ...
                <p className="text-4xl  font-sans text-red-400">A-A</p>
                    ...
                    <form onSubmit={handleSubmit}  className="flex flex-col justify-center items-center py-4 w-full space-y-8" >
                        ...
                        <input type="email" name='email' value={formData.email} onChange={handleChange} className="h-10 w-[50%] pl-2 outline-none  border-[1px] border-red-500 rounded-lg" placeholder="Email"/>
                        <input type="text" name='description' value={formData.description} onChange={handleChange} className="h-10 w-[50%] pl-2 outline-none  border-[1px] border-red-500 rounded-lg"  placeholder="Description"/>
                        <input type="password" name='password' value={formData.password} onChange={handleChange} className="h-10 w-[50%] pl-2  outline-none border-[1px] border-red-500 rounded-lg" placeholder="Password" />
                    ...
                    <div className=" flex flex-row space-x-2">
                       ...
                       <Link href="/login" className='font-bold text-red-500'> Sign In </Link>
                    </div>
                </div>
        </div>
    );
